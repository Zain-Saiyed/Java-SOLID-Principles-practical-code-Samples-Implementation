...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("===========================================================================================");
        System.out.println("*** Failing Dependency Inversion Principle");
        ...
        System.out.println("Total Money Spent with SBI: $"+paymentGateway.getDailyTotalMoneyTransferProcessed());
        System.out.println("Average Customer Transfer with SBI: $"+paymentGateway.getDailyAveragePaymentTransfers());
        id+=1;
    }
}
